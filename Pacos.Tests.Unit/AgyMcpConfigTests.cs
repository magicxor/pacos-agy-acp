...
internal sealed class AgyMcpConfigTests
{
    ...
    {
        var json = AgyMcpConfigHostedService.BuildConfigJson(CreateOptions().McpServers);
    ...
    public void BuildConfigJson_SseServer_EmitsLowercaseTypeAndUrl()
    {
        ...
        var remote = GetServer(AgyMcpConfigHostedService.BuildConfigJson(servers), "remote");
