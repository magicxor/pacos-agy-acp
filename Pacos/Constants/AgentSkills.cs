    ...
    [
        ...
        new AgentSkill
        {
            ...
            Body = """
                   ...
                   Если фичи делятся на несколько НЕУПОРЯДОЧЕННЫХ категорий, градиент из раздела 3 врёт: он навязывает порядок и величину там, где их нет («Бразилия в четыре раза больше Аргентины»?), а его легенда показывает числа вместо названий категорий. Не пытайся подогнать шкалу под категории — ни палитрой D3, ни своей функцией в interpolate с порогами по t: даже если фичи закрасятся правильно, легенда останется числовой полоской 1..N, и понять по ней, где какой язык, будет невозможно.
                   Правильный способ — ОДИН ДАТАСЕТ НА КАТЕГОРИЮ:
