    ...
    [
        ...
        new AgentSkill
        {
            ...
            Body = """
                   ...
                   - Каждая фича, попадающая в кадр, должна получить свою строку в data: фича без строки остаётся серым пятном, и карта выглядит недокрашенной. Если по региону данных действительно нет — оставь его серым осознанно и скажи об этом в ответе.
                   ...
                   Три формы fit:
                   - по списку фич той же карты: "fit": { "map": "rus", "features": ["Amur", "Khabarovsk", "Sakhalin"] } — имена бери из list_maps. Кадр строится по ПОЛНОЙ геометрии этих фич, включая оторванные куски: у Франции в неё входит Гвиана в Южной Америке, у США — Аляска и Гавайи, и кадр растягивается на пол-планеты. Поэтому этот способ — для регионов одной страны, а для набора стран бери прямоугольник координат;
