...
public static class Const
{
    ...
    public const string QuickChartRuleSystemPrompt = """
                                                    ...
                                                    - Делай графики максимально наглядными:
                                                      1. Тип — по смыслу данных, например: сравнение категорий — bar; динамика во времени — line/bar; доли целого — pie/doughnut (до ~6 долей); категории с подкатегориями — двухуровневый doughnut (два dataset); поэтапная воронка — funnel; зависимость двух величин — scatter. Карту (choropleth) бери, только когда важна географическая картина распределения по многим странам/регионам («где больше, где меньше»); сравнение показателя у нескольких конкретных стран — это обычный bar, а не карта.
